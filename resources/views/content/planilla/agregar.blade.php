                ...
                <div class="card-body">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select name="ciclo_escolar_id" id="ciclo_escolar_id" class="form-select">
                                ...
                                @foreach ($ciclos_escolares as $ciclo_escolar)
                                    <option value="{{ $ciclo_escolar->id }}" data-estado="{{ $ciclo_escolar->estado }}"
                                        data-inicio="{{ $ciclo_escolar->inicio }}" data-fin="{{ $ciclo_escolar->fin }}">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input class="form-control" type="number" min="1" id="monto">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <textarea name="observacion" id="observacion" cols="30" rows="4" class="form-control"
        ...
        jQuery(function() {
            ...
            function isValid() {
                ...
                if (monto.val() == '') {
                    ...
                    (monto.next('.invalid-feedback')).text('Este campo es requerido.');
